                    ...
                    <div className="row justify-content-between align-items-center">
                        <div className="col-xl-6 col-lg-6 col-12">
                            <div className="intro-content">
                                <h1>Найшвидший спосіб обміняти криптовалюту - це <strong className="text-primary">Beethoven</strong>.
                            </h1>
                                <p>Хочеш швидко перевести крипту в фіат, або наоборот ми тобі в цьому допоможемо. Ми працюємо 24/7 та максимально швидко обмінюємо будь-яку суму.</p>
                            </div>
